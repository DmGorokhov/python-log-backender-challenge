...
LOG_EVENTS_PARTITION_QUANTITY = env("LOG_EVENTS_PARTITION_QUANTITY", default=500)
LOG_SENDING_FREQUENCY_IN_MINUTES = env("LOG_SENDING_FREQUENCY_IN_MINUTES", default=10)
OUTBOX_CLEAN_IN_MINUTES = env("OUTBOX_CLEAN_IN_MINUTES", default=1440)
FAILED_LOG_SENDING_RETRIES = env("FAILED_LOG_SENDING_RETRIES", default=5)
...
CELERY_BEAT_SCHEDULE = {
    "process_events": {
        "task": "src.core.tasks.process_events",
        "schedule": crontab(minute=f"*/{LOG_SENDING_FREQUENCY_IN_MINUTES}"),
    },
    "clean_events_outbox": {
        "task": "src.core.tasks.clean_events_outbox",
        "schedule": crontab(minute=f"*/{OUTBOX_CLEAN_IN_MINUTES}"),
    },
}
